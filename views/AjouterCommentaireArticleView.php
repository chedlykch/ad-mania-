...
<div id="container">
    <div class="shell">
        <!-- Small Nav -->
        <div class="small-nav"> <a href="#">Commentaire</a> <span>&gt;</span> Ajouter Commentaire Article</div>
        <!-- End Small Nav -->
        <!-- Message OK -->
        ...
        <div id="main">
            ...
            <br> <br>
            <div class="box-head">
                <h2 class="left">Add new comment</h2>
            </div>
            <div class="form">
<form  onsubmit="return validateForm()" name="myForm" method="POST" action="AjouterCommentaireArticleC.php" >
    <div class="row align-items-stretch mb-5">
        <div class="col-md-6">
            <div class="form-group">
               Conetnu <textarea class="form-control"  id="contenu" name="contenu" type="text" placeholder="contenu"/></textarea>
		...
		ID ARTICLE
            ...
            <div id="success"></div>
            <button class="btn btn-primary btn-xl text-uppercase"  type="submit">Commenter</button>
