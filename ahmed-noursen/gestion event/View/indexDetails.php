...
foreach($listeE as $event)
	...
	<link href="css4/style45.css" rel="stylesheet">
		...
		<div class="main-nav">
			...
			<div class="container">
				<div class="header-top">
					...
					<h5><?php foreach($com as $con){echo $con['nom'];} ?> </h5>
			...
			<div class="carousel-inner">
				<div class="item active">
					...
					<div class="carousel-caption">
						...
						<h2>Participer </h2>
						<h3><?php if($event['nb_participant']==0){echo '<img src="sold-out.png">';}else echo $event['nb_participant']; ?></h3>
						<h4>full event package only <?php $prix=$event['prix'];echo $prix; ?> DT</h4>
						
						<?php if($event['nb_participant']!=0){echo '<a href="paiement.php?ref=' ; echo $event['reference'];echo'"';  echo '; type="submit">GRAB YOUR TICKETS <i class="fa fa-angle-right"></i></a>';}?>
						</form></div>
				</div>    
				<div class="item">
					...
					<h2>Participer </h2>
						...
						<?php if($event['nb_participant']!=0){echo '<a href="premium.php?ref='; echo $event['reference'];  echo'&amp ref='; echo $event['reference'];echo'"';  echo ';>GRAB YOUR TICKETS <i class="fa fa-angle-right"></i></a>';}?>
					</div>
				</div>
				<div class="item">
					...
					<h3><?php if($event['nb_participant']==0){echo '<img src="sold-out.png">';}else echo $event['nb_participant']; ?></h3>
						...
						<?php if($event['nb_participant']!=0){echo '<a href="paiement.php?prix='; echo $prix;  echo'&amp ref='; echo $event['reference'];echo'"';  echo ';>GRAB YOUR TICKETS <i class="fa fa-angle-right"></i></a>';}?>
					</div>
				</div>				
			</div>
		</div>    	
				...
				<div class="col-sm-7 col-md-6">					
					<ul id="countdown">
						<li>	
							...
							<span class="days time-font">
							
							
							<?php echo substr($event['da'], 0, 4); ?>
							
							</span>
							<p>année </p>
						</li>
						<li>
							<span class="hours time-font"><?php echo substr($event['da'], 5, 2); ?></span>
							<p class="">month </p>
						</li>
						<li>
							<span class="minutes time-font"><?php echo substr($event['da'], 8, 2); ?></span>
							<p class="">year</p>
						</li>
