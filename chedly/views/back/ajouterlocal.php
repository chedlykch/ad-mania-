    ...
    function validateForm1() {
          ...
          <form action="" method="POST" class="login-html" name="ajouter" onsubmit="return validateForm()" >
            <table border="0" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="id" id="id" value="AUTO_ID"  readonly  maxlength="50" class="tab"></td>
                </tr>
                <tr>
                    <td>
        ...
        <script>
            ...
            function validateForm() {
                var description = document.forms["ajouter"]["nom_rue"].value;
