...
<section id="local">
    <div class="container">
        <form  onsubmit="return validateForm()" name="myForm" method="POST" action="../../Controllers/AjouterReclamation.php" >
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group form-group-textarea mb-md-0">
                            <textarea style = "width: 500px;height: 100px " class="form-control" name="recalamtion"  id="reclamation" placeholder="contenu du reclation"  ></textarea>
                ...
                <div class="text-center">
                    <div id="success"></div>
                    <button class="btn btn-primary btn-xl text-uppercase"  type="submit">Ajouter Recalamtion</button>
                </div>
        </form>
        <!--------- SWALL CONTROLE SAISIE ------->
        ...
        <script>
            ...
            function validateForm() {
                var description = document.forms["myForm"]["recalamtion"].value;

                if (description == "") {
                    swal("Erreur!", "Le champ Contenu RECLAMATION est vide!", "error");
