			...
			<div class="carousel-inner">
				<div class="item active">
					...
					<div class="carousel-caption">
						...
						<?php if($event['nb_participant']!=0){echo '<a href="paiement.php?prix='; echo $event['prix'];  echo'&amp ref='; echo $event['reference'];echo'"';  echo ';>GRAB YOUR TICKETS <i class="fa fa-angle-right"></i></a>';}?>
					</div>
				</div>    
				<div class="item">
